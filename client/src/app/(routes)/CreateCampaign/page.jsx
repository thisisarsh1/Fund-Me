...
import { useStateContext } from "@/context/index"; // Correct import for useStateContext
...
function Page() {
  ...
  const { createCampaign } = useStateContext(); // Use context to get createCampaign function
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Parse the target to the correct format
      const targetInWei = ethers.utils.parseUnits(form.target, 18);

      // Call createCampaign from the context with parsed values
